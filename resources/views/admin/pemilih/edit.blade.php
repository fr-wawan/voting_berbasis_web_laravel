...
<div class="bg-white ml-72 p-10 mb-10 rounded shadow">
  ...
  <form action="{{ route('pemilih.update',$pemilih->id) }}" class="mt-5" method="post" enctype="multipart/form-data">
    ...
    <div class="block my-5">
      ...
      <div class="mt-2">
        <textarea name="alamat" id="alamat"
          ...
          rows="5">{{ $pemilih->alamat }}</textarea>
    ...
    <div class="flex gap-5">
      ...
      <div class="block my-5 mb-10 w-full box-content">
        ...
        <select type="text" name="jenis_kelamin" id="jenis_kelamin"
          ...
          <option value="pria" {{ $pemilih->jenis_kelamin == 'pria' ? 'selected' : '' }}>Pria</option>
          <option {{ $pemilih->jenis_kelamin == 'wanita' ? 'selected' : '' }} value="wanita">Wanita</option>
        </select>
