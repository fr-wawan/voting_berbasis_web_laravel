...
<div class="bg-white ml-72 p-10 rounded shadow">
  ...
  <form action="{{ route('kandidat.update',$kandidat->id) }}" class="mt-5" method="post" enctype="multipart/form-data">
    @method('put')
    @csrf
    ...
    <div class="block my-5 mb-10">
      ...
      <div class="mt-2">
        <textarea name="deskripsi" id="deskripsi"
          ...
          rows="5">{{ $kandidat->deskripsi }}</textarea>
